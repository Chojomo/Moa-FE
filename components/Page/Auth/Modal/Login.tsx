        ...
        <div className="w-full flex flex-col gap-5 justify-center items-center">
          <div className="relative w-full">
            <input
              ...
              className="input-reset w-full autofull-text rounded border border-[#7f7f7f] dark:border-[#c7c7c7] px-[15px] py-[18px] flex-1 placeholder:font-light placeholder:text-[0.8rem] autofill:text-black autofill:shadow-none caret-background"
            />
          </div>
